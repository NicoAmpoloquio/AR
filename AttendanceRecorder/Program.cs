...
namespace Program
{
    internal class Program
    {
            ...
            while (true)
            {
                ...
                switch (input)
                {
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        Console.WriteLine("Thank you for attending our clss. Exiting program...");
                        return;
                    default:
        ...
        static void AddAttendanceUI(AttendanceRecorder recorder)
        {
            ...
            AttendanceRecord attendance = recorder.AddAttendance(number, name, status);
        ...
        static void EditAttendanceUI(AttendanceRecorder recorder)
        {
            ...
            recorder.EditAttendance(number, name, attendanceIndex, newStatus);
